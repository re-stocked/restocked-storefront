  ...
  return sdk.client
    .fetch<{
      ...
      query: {
        ...
        region_id: region?.id,
        fields:
          "*variants.calculated_price,+variants.inventory_quantity,*seller,*variants,*seller.products,*seller.reviews,*seller.reviews.customer,*seller.reviews.seller,*attribute_values,*attribute_values.attribute",
        ...queryParams,
      },
      headers,
      cache: "no-cache",
